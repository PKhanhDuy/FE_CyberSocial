  ...
  return (
    <aside className="fixed right-0 top-0 h-screen w-80 glass-panel border-l border-border z-10 p-6 overflow-y-auto">
      <div className="flex items-center gap-2 mb-8">
        ...
        <h2 className="text-lg font-bold tracking-wider text-foreground">GIÁM SÁT AI</h2>
      </div>

      <div className="space-y-8">
        {/* Network Status */}
        <div className="space-y-4">
          <h3 className="text-sm font-semibold text-muted uppercase tracking-widest">Trạng thái mạng</h3>
          <div className="bg-panel rounded-lg p-4 border border-border space-y-3">
            <div className="flex justify-between items-center text-sm">
              <span className="text-muted">Mức độ đe dọa toàn cầu</span>
            ...
            <div className="flex justify-between items-center text-sm pt-2">
              <span className="text-muted">Tốc độ xử lý</span>
            ...
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-panel rounded-lg p-3 border border-border text-xs font-mono relative overflow-hidden group">
                ...
                <div className="flex justify-between text-muted mb-1">
                  ...
                  <span className="text-accent-blue">ĐANG QUÉT</span>
                </div>
                <div className="text-muted truncate">Đang phân tích ma trận lan truyền...</div>
              </div>
            ))}
          </div>
        </div>
